      ...
      <div className="grid gap-8 md:grid-cols-2 md:items-center">
        <div className="space-y-4">
          <h1 className="text-3xl md:text-4xl font-semibold text-balance">
            Play chess with on‑chain stakes, provable results.
          </h1>
          <p className="text-muted-foreground text-pretty">
            ChainMate lets you challenge opponents, lock stakes in escrow, and settle automatically with verifiable
            proof from Chess.com or Reclaim Protocol.
          </p>
